            ...
            if file_ext == "csv":
                ...
                if not content.strip():
                    ...
                    if required_cols.issubset(df_secondary.columns):
                        ...
                        if st.checkbox("🔍 Show Secondary file preview", value=False, key="secondary_csv_preview"):
                ...
                try:
                    ...
                    if structured_data and csv_io:
                        ...
                        if st.checkbox("🔍 Show Secondary file preview", value=False, key="secondary_pdf_preview"):
                            st.dataframe(df_secondary.head())
                    else:
