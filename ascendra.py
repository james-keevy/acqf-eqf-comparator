...
Provide a similarity score out of 100. Write this as a separate score below your response. Add a visual depiction with one row of 10 circles in a bright colour. Do not use a heading for the slider. Colour the circles that match the scre out of 100 proportionally.
